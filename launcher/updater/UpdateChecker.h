...
public:
    UpdateChecker(shared_qobject_ptr<QNetworkAccessManager> nam, const QString& channelUrl, const QString& currentChannel, int currentBuild);
...
signals:
    ...
    void updateAvailable(const GoUpdate::Status& status);
