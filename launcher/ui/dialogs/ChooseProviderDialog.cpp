...
{
    int btn_index = 0;
    for (const ModPlatform::Provider& provider : { ModPlatform::Provider::MODRINTH, ModPlatform::Provider::FLAME }) {
        QRadioButton* btn = new QRadioButton(ProviderCaps.readableName(provider), this);
