...
- Indent with 4 spaces unless it's in a submodule.
- Keep lists (of arguments, parameters, initializers...) as lists, not paragraphs. It should either read from top to bottom or left to right. Not both.

## Signing your work

To ensure that the code you contribute is compatible with the licenses in this codebase, we require you to sign off all your contributions.
...
(c) The contribution was provided directly to me by some other
    person who certified (a), (b), or off (c) and I have not modified
    it.
...
These terms will be enforced once you create a pull request, and you will be informed automatically if any of your commits aren't signed by you.
